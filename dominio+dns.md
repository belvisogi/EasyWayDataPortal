---
title: "Scelta Dominio e Registrar - Approccio Privacy/Ethics First (livello 10/10)"
tags: [domain, registrar, dns, privacy, gdpr, on-prem, security, compliance, decision-log]
date: 2026-02-01
status: stable
---
...
Reverse Proxy (HTTPS)
↓
Applicazioni on-prem


**Nota chiave:**  
Registrar e DNS **non devono mai intercettare il traffico applicativo**, ma solo risolvere il nome.

---

## DNS – configurazione consigliata
...
example.com A <IP_PUBBLICO_STATICO>
www.example.com
 A <IP_PUBBLICO_STATICO>
 
 
#### (Opzionale) Record AAAA (IPv6)
example.com AAAA <IPv6_PUBBLICO>
...
### Record CAA (consigliato – sicurezza certificati)
Limita chi può emettere certificati TLS per il dominio.
...
### Record TXT – policy e verifiche

#### SPF (se usi email dal dominio)
